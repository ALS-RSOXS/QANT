...
function QANT_multipeakBatchfit(peakset, datawaves, xwaves, tracenames,name)
	...
	make /o/n=4 /t listpeakcolumnnames = {"Peak","St�hr 9.16a","St�hr 9.17a","St�hr 9.14a"}
	...
	string outputstring = "Peak\tFit to St�hr 9.16a\tUncertainty\tFit to St�hr 9.17a\tUncertainty\tFit to St�hr 9.14a\tUncertainty\r"
	for(j=0;j<dimsize(peakset,0);j+=1)
		for(k=0;k<7;k+=1)
...
function QANT_PeakFitResultsPanelfunc([val])
	...
	PopupMenu popup0,mode=plot16a,value= #"\"Vector symmetry (St�hr 9.16a);Planar symmetry (St�hr 9.17a);In-Plane Alignment (St�hr 9.14a)\""
	...
	if(nwavesplotted>0)
		...
		if(useangles && combined && sum(angles)*0 ==0)
			...
			elseif(plot16a==1)
				...
				TextBox/C/N=text1/A=RB/X=5.00/Y=15.00/E=2 "Fit to the vector symmetry formula St�hr 9.16a\r\\F'Symbol'g\\F]0 = " + fitresult16a
			elseif(plot16a==2)
				if(w_sigma[0]<1)
					sprintf fitresult17a, "%2.4g � %2.2g", angleout, w_sigma[0]
				else
				...
				TextBox/C/N=text1/A=RB/X=5.00/Y=15.00/E=2 "Fit to the planar symmetry formula St�hr 9.17a\r\\F'Symbol'g\\F]0 = " + fitresult17a
			elseif(plot16a==3)
				if(w_sigma[0]<1)
					sprintf fitresultaligned, "%2.4g � %2.2g", angleout, w_sigma[0]
				else
				...
				TextBox/C/N=text1/A=RB/X=5.00/Y=15.00/E=2 "Fit to the vector symmetry with in-plane alignment St�hr 9.14a\r\\F'Symbol'g\\F]0 = " + fitresultaligned
			endif
